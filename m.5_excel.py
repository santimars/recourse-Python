...
hoja_dos = wb.sheetnames[2]
print("hoja otros",hoja_dos)
...
wb = openpyxl.load_workbook("/Users/santirodriguez/Desktop/Excel2.xlsx") # aqui le referescamos la informacion de nuevo
hoja_uno = wb["address"]
...
wb.save("/Users/santirodriguez/Desktop/Excel2.xlsx") # Guardamos datos antes de ejecutar el resto
...
try: 
 ...
 #Guardar cambios
 wb.save("/Users/santirodriguez/Desktop/02_Excel_data 3.xlsx") # Guardamos datos antes de ejecutar el resto
